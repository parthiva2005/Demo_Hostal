...
import {
  MapPin, MessageSquare, IndianRupee, Calendar, Star,
  CheckCircle2, CreditCard, AlertCircle, XCircle
} from "lucide-react";
      ...
      <div className="mt-8">
        ...
        <div className="mt-4 grid gap-4 sm:grid-cols-2">
          {savedPGs.map((pg, i) => (
            ...
            >
              <div className="h-20 w-24 overflow-hidden rounded-lg shrink-0 relative">
                <Image src={pg.image} alt={pg.name} fill className="object-cover" />
              </div>
